...
/// Provides navigation registration for the Onboarding feature.
public enum OnboardingNavigationViewProvider {
    
    /// Registers the Onboarding view in the given navigation registry.
    ...
    public static func register(in registry: NavigationRegistryProtocol) {
        ...
        registry.registerView(OnboardingNavData.self) { _ in
