...
final class SignUpUserUCTests: XCTestCase {
    ...
    func testExecute_Success() async throws {
        ...
        repo.stub.signupNameEmailPassword_Async_UserData = { userData in
        ...
        // Act
        let receivedUser = try await uceCase.execute(name: testName, email: testEmail, password: testPass)
        
        // Assert
        XCTAssertEqual(repo.verify.signupNameEmailPassword_Async_UserData.count, 1)
    ...
    func testExecute_Error() async throws {
        ...
        repo.stub.signupNameEmailPassword_Async_UserData = { _ in
            throw NSError(domain: "AuthError", code: 401, userInfo: nil)
        }
        
        // Act
        do {
            _ = try await uceCase.execute(name: "Kris", email: "kris@test.gr", password: "123")
